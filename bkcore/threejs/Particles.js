...
bkcore.threejs.Particles = function (opts) {
  ...
  this.material = new THREE.ParticleBasicMaterial({
    ...
    blending:
      opts.blending == undefined ? THREE.AdditiveBlending : opts.blending,
  ...
  this.velocity =
    opts.velocity == undefined ? new THREE.Vector3() : opts.velocity;
  this.randomness =
    opts.randomness == undefined ? new THREE.Vector3() : opts.randomness;
  this.force = opts.force == undefined ? new THREE.Vector3() : opts.force;
  this.spawnRadius =
    opts.spawnRadius == undefined ? new THREE.Vector3() : opts.spawnRadius;
  ...
  this.position =
    opts.position == undefined ? new THREE.Vector3() : opts.position;
  this.rotation =
    opts.rotation == undefined ? new THREE.Vector3() : opts.rotation;
